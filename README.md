...
| プレビュー画像 | デモ動画 |
| :---: | :---: |
| <img src="docs/preview.png" alt="AviUtl2で動作するJIZURAのプレビュー" width="1280"> | https://github.com/user-attachments/assets/aaea6fbc-d10e-4c81-b263-32d661f21e74 |
...
開発版の描画エンジンは上流 JIZURA **v0.9.0** を取り込んでいます。タイポグラフィ・キネティック・ホラーの演出群、カットごとの選択と固定、ループ設定、ベトナム語への対応を含みます。
...
- 歌詞の言語を自動判定し、日本語・中国語・韓国語・英語・ベトナム語に応じたフォントで描画
...
![AviUtl2でカットの演出や色を編集する設定画面](docs/aviutl2-settings.png)
